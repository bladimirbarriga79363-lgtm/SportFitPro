    ...
    template: `
        <footer>
            ...
            <div style="display: flex; justify-content: center; gap: 15px; margin-top: 10px;">
                <a href="#" onclick="window.open('https://validator.w3.org/nu/?doc=' + encodeURIComponent(window.location.href), '_blank'); return false;">
    <img src="https://www.w3.org/Icons/valid-html401" alt="W3C HTML Válido" style="border:0;width:88px;height:31px">
</a>
                <a href="https://jigsaw.w3.org/css-validator/validator?uri=https://sportfitpro.mexicocentral.cloudapp.azure.com:3000/assets/css/styles.css" target="_blank">
